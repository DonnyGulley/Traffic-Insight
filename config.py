...
# Database configuration
DB_CONNECTION_STRING_TWITTERXETL = 'DRIVER={ODBC Driver 17 for SQL Server};lp-windows11\\DGSQL;DATABASE=TrafficInsight_Tweets;Trusted_Connection=yes;'
DB_CONNECTION_STRING_CollisionETL ='DRIVER={ODBC Driver 17 for SQL Server};lp-windows11\\DGSQL;DATABASE=TrafficInsight_ETL;Trusted_Connection=yes;'
DB_CONNECTION_STRING_TRAFFICINSIGHT = 'DRIVER={ODBC Driver 17 for SQL Server};lp-windows11\\DGSQL;DATABASE=TrafficInsight;Trusted_Connection=yes;'
