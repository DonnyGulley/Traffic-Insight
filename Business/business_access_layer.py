...
class BusinessAccessLayer:
    def __init__(self):
        ...
        database = os.getenv("DB_NAME", "TrafficInsight_ETL")
        self.dal = DataAccessLayer(server=server, database=database)

    def get_activity_logs(self):
        return self.dal.get_activity_logs()
    ...
    def plot_accidents_by_collisionDate(self, start_date, end_date):
        ...
        self.dal.log_activity("Plot Accidents by Collision Date", log_details)
    ...
    def plot_accidents_by_impact_type(self, impact_type, impact_type_name):
        ...
        self.dal.log_activity("Plot Accidents by Impact Type", log_details)
    ...
    def plot_accidents_by_road_jurisdiction(self):
        ...
        self.dal.log_activity("Plot Accidents by Road Jurisdiction", log_details)
    ...
    def plot_accidents_by_traffic_condition(self):
        ...
        # Log this activity
        log_details = f"Records: {len(data)}"
        self.dal.log_activity("Plot Accidents by Traffic Condition", log_details)
